    ...
    loadData (pagination, filters, sorter) {
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(r => {
          ...
          if (r.hasOwnProperty("recordList")){
            if ((r.recordList.length === 0) && this.showPagination && this.localPagination.current > 1) {
              this.localPagination.current--
              this.loadData()
              return
            }
          }
          if (r.hasOwnProperty("replayList")){
            if ((r.replayList.length === 0) && this.showPagination && this.localPagination.current > 1) {
              this.localPagination.current--
              this.loadData()
              return
            }
          ...
          this.localDataSource = r.hasOwnProperty("data") ? r.data : r.hasOwnProperty("recordList") ? r.recordList : r.hasOwnProperty("replayList") ? r.replayList : [] // 返回结果中的数组数据
