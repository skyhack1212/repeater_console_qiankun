                    ...
                    <a-row :gutter="48">
                        <a-col :md="8" :sm="24">
                            <a-form-item label="应用名称">
                                <a-input v-model="configForms.appName" disabled />
                            </a-form-item>
                        </a-col>
                        <a-col :md="8" :sm="24">
                            <a-form-item label="环境">
                                <a-input v-model="configForms.environment" disabled />
                            </a-form-item>
                        </a-col>
                    </a-row>
                    <a-row :gutter="48">
...
<!--                            <a-tabs v-model="helpTab" type="card" @change="callback">-->
                    ...
                    >
                        ...
                        <a-button type="danger" style="margin-left: 8px" >
                            <router-link :to="{name:'ConfigEdit',params:{id:configId}}">
                                编辑
                            </router-link>
                        </a-button>
                    </a-form-item>
...
<script>
    ...
    import { config_detail } from '@/api/repeate'
 ...
 "degrade": false,
  ...
  "useTtl": true
        ...
        created () {
            ...
            this.configId = Number(this.$route.params.id);
            console.log(this.configId)
            config_detail({id: this.configId})
                .then(res => {
