                    ...
                    <a-row :gutter="48">
                        <a-col :md="8" :sm="24">
                            <a-form-item label="应用名称">
                                <a-input v-model="onlineParams.appName" placeholder="请输入应用名称"/>
                            </a-form-item>
                        </a-col>
                        <a-col :md="8" :sm="24">
                            <a-form-item label="流量入口">
                                <a-input v-model="onlineParams.entranceDesc" placeholder="请输入流量入口"/>
                            </a-form-item>
                        </a-col>
                        <template v-if="advanced">
                            <a-col :md="8" :sm="24">
                                <a-form-item label="环境">
                                    <a-input v-model="onlineParams.environment" placeholder="请输入环境"/>
                                </a-form-item>
                            </a-col>
                            <a-col :md="8" :sm="24">
                                <a-form-item label="机器IP">
                                    <a-input v-model="onlineParams.host" placeholder="请输入机器IP"/>
                                </a-form-item>
                            </a-col>
                            <a-col :md="8" :sm="24">
                                <a-form-item label="TraceID">
                                    <a-input v-model="onlineParams.traceId" placeholder="请输入TraceID"/>
                                </a-form-item>
                            </a-col>
                            <a-col :md="8" :sm="24">
                                <a-form-item label="回放状态">
                                    <a-select v-model="onlineParams.hasDiff" placeholder="请选择" default-value="0">
                                        <a-select-option value="-1">全部</a-select-option>
                                        <a-select-option value="0">未回放</a-select-option>
                                        <a-select-option value="1">无差异</a-select-option>
                            ...
                            <a-col :md="8" :sm="24">
                                <a-form-item label="更新日期">
                                    <a-date-picker v-model="listForSelect.id" style="width: 100%" placeholder="请输入更新日期"/>
                                </a-form-item>
                            </a-col>
                        </template>
                        ...
                        <a-col :span="4">
                            <a-form-item label="回放状态">
                                <a-select
                                        ...
                                        placeholder="请选择" style="width: 120px" @change="handleChange"
                                >
...
<!--                                    </a-select-option>-->
                    ...
                    <a-row>
                        <a-col :span="24" :style="{ textAlign: 'center' }">
                            ...
                            <a-button :style="{ marginLeft: '18px' }" @click="handleReset">
                                重置
                            </a-button>
                        </a-col>
                    </a-row>
    ...
    export default {
        data() {
            return {
                ...
                loading: false,
                expand: false,
                form: this.$form.createForm(this, {name: "查询表单"}),
                onlineParams: {
                    "appName":"",
                    "entranceDesc":"",
                    "traceId":"",
        ...
        methods: {
            ...
            async handleSearch(e, pagination) {
                e.preventDefault();
                this.form.validateFields((error, values) => {
                    console.log('error', error);
                    console.log('Received values of form: ', values);
                    console.log('form', values.form);
                    if (JSON.stringify(values.form) !== "{}") {
                        for(const key in values.form) {
                            this.onlineParams[key] = values[key]
                        }
                    }
                });
                this.onlineParams.pageIndex = pagination.pageIndex;
                this.onlineParams.pageSize = pagination.pageSize;
                const result = await online_search(this.onlineParams);
                console.log(result);
